...
*QueryApi* | [**PostExemplarsQuery**](docs/QueryApi.md#postexemplarsquery) | **Post** /v1alpha1/query_exemplars | Experimental: Exemplars for a specific time range
*QueryApi* | [**PostInstantQuery**](docs/QueryApi.md#postinstantquery) | **Post** /v1alpha1/query | Instant query at a single point in time
*QueryApi* | [**PostRangeQuery**](docs/QueryApi.md#postrangequery) | **Post** /v1alpha1/query_range | Query over a range of time
