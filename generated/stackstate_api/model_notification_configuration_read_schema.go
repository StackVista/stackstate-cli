...
func NewNotificationConfigurationReadSchema(name string, notifyHealthStates NotifyOnOptions, monitors []MonitorReferenceId, monitorTags []string, componentTypes []int64, componentTags []string, status NotificationConfigurationStatusValue, notificationChannels []ChannelReferenceId, id int64, lastUpdateTimestamp int64, runtimeStatus NotificationConfigurationRuntimeStatusValue) *NotificationConfigurationReadSchema {
	this := NotificationConfigurationReadSchema{}
	this.Name = name
...
func (o NotificationConfigurationReadSchema) MarshalJSON() ([]byte, error) {
...
type NullableNotificationConfigurationReadSchema struct {
	value *NotificationConfigurationReadSchema
	isSet bool
}

func (v NullableNotificationConfigurationReadSchema) Get() *NotificationConfigurationReadSchema {
	return v.value
}

func (v *NullableNotificationConfigurationReadSchema) Set(val *NotificationConfigurationReadSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationConfigurationReadSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationConfigurationReadSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationConfigurationReadSchema(val *NotificationConfigurationReadSchema) *NullableNotificationConfigurationReadSchema {
	return &NullableNotificationConfigurationReadSchema{value: val, isSet: true}
}

func (v NullableNotificationConfigurationReadSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationConfigurationReadSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
