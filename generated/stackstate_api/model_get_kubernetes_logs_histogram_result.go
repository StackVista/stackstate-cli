...
func NewGetKubernetesLogsHistogramResult(buckets []KubernetesLogHistogramBucket) *GetKubernetesLogsHistogramResult {
	this := GetKubernetesLogsHistogramResult{}
...
func (o *GetKubernetesLogsHistogramResult) GetBuckets() []KubernetesLogHistogramBucket {
	if o == nil {
		var ret []KubernetesLogHistogramBucket
		return ret
	}
...
func (o GetKubernetesLogsHistogramResult) MarshalJSON() ([]byte, error) {
...
type NullableGetKubernetesLogsHistogramResult struct {
	value *GetKubernetesLogsHistogramResult
	isSet bool
}

func (v NullableGetKubernetesLogsHistogramResult) Get() *GetKubernetesLogsHistogramResult {
	return v.value
}

func (v *NullableGetKubernetesLogsHistogramResult) Set(val *GetKubernetesLogsHistogramResult) {
	v.value = val
	v.isSet = true
}

func (v NullableGetKubernetesLogsHistogramResult) IsSet() bool {
	return v.isSet
}

func (v *NullableGetKubernetesLogsHistogramResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetKubernetesLogsHistogramResult(val *GetKubernetesLogsHistogramResult) *NullableGetKubernetesLogsHistogramResult {
	return &NullableGetKubernetesLogsHistogramResult{value: val, isSet: true}
}

func (v NullableGetKubernetesLogsHistogramResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetKubernetesLogsHistogramResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
