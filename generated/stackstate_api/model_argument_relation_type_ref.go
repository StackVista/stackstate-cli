...
type ArgumentRelationTypeRef struct {
	...
	RelationType        int64  `json:"relationType" yaml:"relationType"`
}
...
func (o ArgumentRelationTypeRef) MarshalJSON() ([]byte, error) {
...
type NullableArgumentRelationTypeRef struct {
	value *ArgumentRelationTypeRef
	isSet bool
}

func (v NullableArgumentRelationTypeRef) Get() *ArgumentRelationTypeRef {
	return v.value
}

func (v *NullableArgumentRelationTypeRef) Set(val *ArgumentRelationTypeRef) {
	v.value = val
	v.isSet = true
}

func (v NullableArgumentRelationTypeRef) IsSet() bool {
	return v.isSet
}

func (v *NullableArgumentRelationTypeRef) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableArgumentRelationTypeRef(val *ArgumentRelationTypeRef) *NullableArgumentRelationTypeRef {
	return &NullableArgumentRelationTypeRef{value: val, isSet: true}
}

func (v NullableArgumentRelationTypeRef) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableArgumentRelationTypeRef) UnmarshalJSON(src []byte) error {
	v.isSet = true
