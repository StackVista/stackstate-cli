...
func (o MonitorDefId) MarshalJSON() ([]byte, error) {
...
type NullableMonitorDefId struct {
	value *MonitorDefId
	isSet bool
}

func (v NullableMonitorDefId) Get() *MonitorDefId {
	return v.value
}

func (v *NullableMonitorDefId) Set(val *MonitorDefId) {
	v.value = val
	v.isSet = true
}

func (v NullableMonitorDefId) IsSet() bool {
	return v.isSet
}

func (v *NullableMonitorDefId) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonitorDefId(val *MonitorDefId) *NullableMonitorDefId {
	return &NullableMonitorDefId{value: val, isSet: true}
}

func (v NullableMonitorDefId) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonitorDefId) UnmarshalJSON(src []byte) error {
	v.isSet = true
