...
func NewServiceTokenInvalidExpiryError(type_ string, message string) *ServiceTokenInvalidExpiryError {
	this := ServiceTokenInvalidExpiryError{}
	this.Type = type_
...
func (o ServiceTokenInvalidExpiryError) MarshalJSON() ([]byte, error) {
...
type NullableServiceTokenInvalidExpiryError struct {
	value *ServiceTokenInvalidExpiryError
	isSet bool
}

func (v NullableServiceTokenInvalidExpiryError) Get() *ServiceTokenInvalidExpiryError {
	return v.value
}

func (v *NullableServiceTokenInvalidExpiryError) Set(val *ServiceTokenInvalidExpiryError) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceTokenInvalidExpiryError) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceTokenInvalidExpiryError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceTokenInvalidExpiryError(val *ServiceTokenInvalidExpiryError) *NullableServiceTokenInvalidExpiryError {
	return &NullableServiceTokenInvalidExpiryError{value: val, isSet: true}
}

func (v NullableServiceTokenInvalidExpiryError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceTokenInvalidExpiryError) UnmarshalJSON(src []byte) error {
	v.isSet = true
