...
func (o ArgumentPromQLMetricVal) MarshalJSON() ([]byte, error) {
...
type NullableArgumentPromQLMetricVal struct {
	value *ArgumentPromQLMetricVal
	isSet bool
}

func (v NullableArgumentPromQLMetricVal) Get() *ArgumentPromQLMetricVal {
	return v.value
}

func (v *NullableArgumentPromQLMetricVal) Set(val *ArgumentPromQLMetricVal) {
	v.value = val
	v.isSet = true
}

func (v NullableArgumentPromQLMetricVal) IsSet() bool {
	return v.isSet
}

func (v *NullableArgumentPromQLMetricVal) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableArgumentPromQLMetricVal(val *ArgumentPromQLMetricVal) *NullableArgumentPromQLMetricVal {
	return &NullableArgumentPromQLMetricVal{value: val, isSet: true}
}

func (v NullableArgumentPromQLMetricVal) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableArgumentPromQLMetricVal) UnmarshalJSON(src []byte) error {
	v.isSet = true
