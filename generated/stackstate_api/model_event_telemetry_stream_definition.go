...
func NewEventTelemetryStreamDefinition(type_ string, bindQuery string, dataSourceId int64, labels []string, name string, priority TelemetryStreamPriority, telemetryQuery EventTelemetryQuery, topologyMapping []TopologyMapping) *EventTelemetryStreamDefinition {
	this := EventTelemetryStreamDefinition{}
	this.Type = type_
...
func (o EventTelemetryStreamDefinition) MarshalJSON() ([]byte, error) {
...
type NullableEventTelemetryStreamDefinition struct {
	value *EventTelemetryStreamDefinition
	isSet bool
}

func (v NullableEventTelemetryStreamDefinition) Get() *EventTelemetryStreamDefinition {
	return v.value
}

func (v *NullableEventTelemetryStreamDefinition) Set(val *EventTelemetryStreamDefinition) {
	v.value = val
	v.isSet = true
}

func (v NullableEventTelemetryStreamDefinition) IsSet() bool {
	return v.isSet
}

func (v *NullableEventTelemetryStreamDefinition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEventTelemetryStreamDefinition(val *EventTelemetryStreamDefinition) *NullableEventTelemetryStreamDefinition {
	return &NullableEventTelemetryStreamDefinition{value: val, isSet: true}
}

func (v NullableEventTelemetryStreamDefinition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEventTelemetryStreamDefinition) UnmarshalJSON(src []byte) error {
	v.isSet = true
