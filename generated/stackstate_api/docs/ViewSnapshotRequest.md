...
**ViewId** | Pointer to **int64** | View identifier that gets mapped back in the response. Preserved for compatibility when this API got moved to OpenAPI. Not used for any processing. | [optional] 
