...
func (o WebhookChannelRefId) MarshalJSON() ([]byte, error) {
...
type NullableWebhookChannelRefId struct {
	value *WebhookChannelRefId
	isSet bool
}

func (v NullableWebhookChannelRefId) Get() *WebhookChannelRefId {
	return v.value
}

func (v *NullableWebhookChannelRefId) Set(val *WebhookChannelRefId) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookChannelRefId) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookChannelRefId) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookChannelRefId(val *WebhookChannelRefId) *NullableWebhookChannelRefId {
	return &NullableWebhookChannelRefId{value: val, isSet: true}
}

func (v NullableWebhookChannelRefId) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhookChannelRefId) UnmarshalJSON(src []byte) error {
	v.isSet = true
